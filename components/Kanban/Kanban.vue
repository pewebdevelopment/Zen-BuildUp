<template>
  ...
  <NuxtLayout name="zen">
    <div id="root" class="flex grow bg-slate-50 dark:bg-navy-900">
      ...
      <div class="main-content kanban-app w-full">
        ...
        <div
          class="h-full flex-row max-w-[100vw] overflow-x-auto scrollbar-thin dark:scrollbar-thumb-gray-900 dark:scrollbar-track-gray-800 scrollbar-thumb-gray-700 scrollbar-track-gray-400 scrollbar-thumb-rounded kanban-scrollbar flex w-full items-start space-x-4 overflow-y-hidden px-[var(--margin-x)] transition-all duration-[.25s]"
        >
          <draggable
            id="tasks-group"
            :list="taskCategories"
          ...
          >
            <template #item="{ element, index }">
              <div
                class="max-h-[50vh] draggable inline-block relative max-w-full shrink-0 pr-3 overflow-x-auto scrollbar-thin dark:scrollbar-thumb-gray-900 dark:scrollbar-track-gray-800 scrollbar-thumb-gray-700 scrollbar-track-gray-400 scrollbar-thumb-rounded overflow-y-scroll duration-[.25s]"
              >
                <div
